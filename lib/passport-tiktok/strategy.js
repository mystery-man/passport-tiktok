...
Strategy.prototype.userProfile = function(accessToken, authData, done) {
    ...
    const params = {
        fields: ["open_id", "union_id", "avatar_url", "avatar_url_100", "avatar_url_200", "avatar_large_url", "display_name", "bio_description", "profile_deep_link", "is_verified", "follower_count", "following_count", "likes_count"]
    }
